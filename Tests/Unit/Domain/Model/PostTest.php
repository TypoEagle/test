...
{
    /**
     * @var \Typovision\Simpleblog\Domain\Model\Post
     */
    ...
    {
        parent::setUp();
        $this->subject = new \Typovision\Simpleblog\Domain\Model\Post();
    }
    ...
    {
        $comment = new \Typovision\Simpleblog\Domain\Model\Comment();
    ...
    {
        $authorFixture = new \Typovision\Simpleblog\Domain\Model\Author();
    ...
    {
        $tag = new \Typovision\Simpleblog\Domain\Model\Tag();
