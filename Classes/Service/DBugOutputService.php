...
class DBugOutputService implements \TYPO3\CMS\Core\SingletonInterface
{
    var $xmlDepth=array();
    var $xmlCData;
    var $xmlSData;
    ...
    public function outPutDebug($var,$forceType="",$bCollapsed=false){
    ...
    function makeTableHeader($type,$header,$colspan=2) {
        ...
        echo "<table cellspacing=2 cellpadding=3 class=\"dBug_".$type. " noprint\">
				<tr>
